...
object ChapterNineQuizReadingB {
    val questions = listOf(
        ...
        q(8, "900.000 + 33.000 + 403 adalah ...", listOf("933.403", "903.343", "930.403", "933.043"), "933.403", "Komposisi nilai tempatnya adalah 900.000 + 33.000 + 403, sehingga jumlahnya 933.403.", "menantang", 291)
    )
